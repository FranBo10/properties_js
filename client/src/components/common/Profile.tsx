...
const Profile = ({ type, name, avatar, email, properties }: ProfileProps) => (
  <Box>
    <Typography fontSize={25} fontWeight={700} ml={5} color="#11142D">{type} Profil</Typography>
          ...
          <Box flex={1} display="flex" flexDirection={{ xs: 'column', md: 'row' }} gap="20px">
            ...
            <Box flex={1} display="flex" flexDirection="column" justifyContent="space-between" gap="30px">
              <Stack direction="column">
                ...
                <Typography fontSize={16} color="#808191">Agent immobilière</Typography>
              </Stack>
    ...
    <Box
      ...
      bgcolor="#FCFCFC"
    >
      <Typography fontSize={18} fontWeight={600} color="#11142D">Mes Propriétées</Typography>
